...
<div> <h2 class="text-info titulo"><strong>Registro Producto</strong></h2></div>

<div class="col-md-10" style="margin-left: 9%;">
<div class="control-group">
	<label class="control-label" for="user" >Nombre <span class="text-danger">*</span></label>
	<div class="controls">
	<input type="text" name="nombre" id="nombre" onkeyup="mayus(this);" onkeypress="return validar_saltos(event);"  class="form-control" pattern="[A-Za-z 0-9]*" maxlength="30" required=""></input>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
	<textarea name="descripcion" id="descripcion" onkeyup="mayus(this);" onkeypress="return validar_string_puntos(event);" cols="30" rows="2" class="form-control"></textarea>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
      ...
      <option value="llamadas">Servidor Team Speak</option>
		</select>
	</div>
</div>

<div class="div_montos" style="margin-top: 20px;opacity: 0">
	<h4>Ingrese Montos o Planes</h4>
	<div class="table-responsive">  
            <table class="table table-bordered" id="dynamic_field">  
                 <tr>  
                      <td width="90%"><input type="text" name="montos[]" onkeypress="return validar_string(event);" class="form-control name_list" required></td>  
