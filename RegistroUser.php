...
<form action="ProcesarUser.php" method="POST" class="form-horizontal" id="formusuarios">
...
<br>
					<center><button type="submit" class="btn btn-success">Registrar Nuevo Usuario</button>
&nbsp;&nbsp;&nbsp;&nbsp;
